...
export const Dashboard = () => {
  ...
  return (
    <div className="view-section fade-enter space-y-6">
      ...
      <div className="sticky top-[58px] md:top-[72px] z-10 bg-[#1C1C1E] dark:bg-[#1C1C1E] backdrop-blur-xl rounded-3xl p-6 text-white relative overflow-hidden shadow-2xl ring-1 ring-black/5 dark:ring-white/10 transition-all">
