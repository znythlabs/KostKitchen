          ...
          <div className="flex items-center gap-2 overflow-x-auto p-3 -m-1 no-scrollbar">
            ...
            {!inventoryEditMode && (
              ...
              >
                ...
                {lowStockCount > 0 && (
                  <span className="absolute -top-1 -right-0 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white shadow-sm ring-2 ring-white dark:ring-[#1C1C1E] animate-bounce z-10">
                    {lowStockCount}
                  </span>
                )}
              </button>
            ...
            <button id="inventory-add-btn" onClick={() => openModal('stock', undefined, activeTab)} className="whitespace-nowrap px-4 py-2.5 bg-[#007AFF] text-white text-sm font-semibold rounded-full shadow-sm active-scale flex items-center gap-2">
